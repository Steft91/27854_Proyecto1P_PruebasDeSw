...
describe('ProductoService', () => {
    ...
    it('obtenerTodos: debe retornar productos (GET)', () => {
        ...
        { codeProduct: 'P1', nameProduct: 'A', descriptionProduct: 'D', priceProduct: 10, stockProduct: 5 }
        ];
    ...
    it('crear: debe enviar producto (POST)', () => {
        const nuevoProd: Producto = { codeProduct: 'P2', nameProduct: 'B', descriptionProduct: 'D', priceProduct: 20, stockProduct: 10 };
    ...
    it('actualizar: debe enviar actualización (PUT)', () => {
        const id = 'P1';
        const datos: Producto = { codeProduct: 'P1', nameProduct: 'Edit', descriptionProduct: 'D', priceProduct: 10, stockProduct: 5 };
